      ...
      <div className="auth-card">
        ...
        {mode === "login" && (
          <>
            ...
            <p onClick={goToRegister} style={{ cursor: "pointer", color: "orange", fontWeight: "bold" }}>Create Account</p>
            <p onClick={goToForgot} style={{ cursor: "pointer", color: "orange", fontWeight: "bold" }}>Forgot Password?</p>
          </>
        )}
        ...
        {mode === "register" && (
          <>
            ...
            <p onClick={goToLogin} style={{ cursor: "pointer", color: "orange", fontWeight: "bold" }}>Already have an account? Login</p>
          </>
        )}
        ...
        {mode === "otp" && (
          <>
            <input
              placeholder={otpMode === "reset" ? "Enter password reset code" : "Enter verification code"}
              value={otp}
            ...
            <p style={{ fontSize: "12px", color: "gray" }}>
              {otpMode === "reset" ? "Password reset code valid for 5 minutes" : "Verification code valid for 5 minutes"}
            </p>
            <button onClick={handleVerifyOTP}>{otpMode === "reset" ? "Reset Password" : "Verify Account"}</button>
            <button onClick={resendOTP} disabled={!canResend}>Resend Code</button>
            <p>{canResend ? "You can resend now" : `Resend available in ${timer}s`}</p>
          </>
        )}
        ...
        {mode === "forgot" && (
          <>
            ...
            <p onClick={goToLogin} style={{ cursor: "pointer", color: "orange", fontWeight: "bold" }}>Back to Login</p>
          </>
        )}
